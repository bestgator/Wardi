...
<?php $__env->startSection('content'); ?>
        ...
        <div class="col-md-12 col-lg-6 col-xl-4">
            <div class="mycard bg1">
                <div class="left">
                    ...
                    <span class="number"><?php echo e($pending); ?></span>
        ...
        <div class="col-md-12 col-lg-6 col-xl-4">
            <div class="mycard bg2">
                <div class="left">
                    ...
                    <span class="number"><?php echo e($processing); ?></span>
        ...
        <div class="col-md-12 col-lg-6 col-xl-4">
            <div class="mycard bg3">
                <div class="left">
                    ...
                    <span class="number"><?php echo e($completed); ?></span>
        ...
        <div class="col-md-6 col-xl-3">
            <div class="card c-info-box-area">
                <div class="c-info-box box1">
                    <p><?php echo e(App\Models\User::where( 'created_at', '>', Carbon\Carbon::now()->subDays(30))->count()); ?></p>
                </div>
        ...
        <div class="col-md-6 col-xl-3">
            <div class="card c-info-box-area">
                <div class="c-info-box box3">
                    <p><?php echo e(App\Models\Order::where('status','=','completed')->where( 'created_at', '>', Carbon\Carbon::now()->subDays(30))->count()); ?></p>
                </div>
                <div class="c-info-box-content">
    ...
    <div class="row row-cards-one">
        ...
        <div class="col-md-12 col-lg-12 col-xl-12">
                <div class="card">
                        <h5 class="card-header"><?php echo e(__('Popular Products')); ?> (For Last 7 Days)</h5>
                        <div class="card-body">
                            ...
                            <div class="table-responsiv  dashboard-home-table">
                                <table id="poproducts" class="table table-hover dt-responsive" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <?php
                                                $pro = \App\Models\Product::find($data->id);
                                            ?>

                                        <td><img src="<?php echo e($pro->ShowPhoto()); ?>"></td>
                                        <td><?php echo e(mb_strlen(strip_tags($data->name_en),'utf-8') > 50 ? mb_substr(strip_tags($data->name_en),0,50,'utf-8').'...' : strip_tags($data->name_en)); ?></td>
                                        <td>
                                                <?php echo e($data->cat_name); ?>

                                                
                                            </td>
                                            <td><?php echo e($data->views_c); ?></td>

                                            <td> <?php echo e($pro->showPrice()); ?> </td>
                                ...
                                <table id="pproducts" class="table table-hover dt-responsive" cellspacing="0" width="100%">
                                        <thead>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                <td><img src="<?php echo e($data->ShowPhoto()); ?>"></td>
                                                <td><?php echo e(mb_strlen(strip_tags($data->name_en),'utf-8') > 50 ? mb_substr(strip_tags($data->name_en),0,50,'utf-8').'...' : strip_tags($data->name_en)); ?></td>
                                                <td><?php echo e($data->category->name_en); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /usr/local/var/www/wardi/resources/views/admin/dashboard.blade.php ENDPATH**/ ?>