                    ...
                    <div class="product-description">
                      ...
                      <form id="geniusformdata" action="<?php echo e(route('admin-cat-create')); ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="name_en" placeholder="<?php echo e(__('Enter Name EN')); ?>" required="" value="">
                          </div>
                        </div>
                        <div class="row">
                          <div class="col-lg-4">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="name_ar" placeholder="<?php echo e(__('Enter Name AR')); ?>" required="" value="">
                          </div>
                        </div>
...
<?php echo $__env->make('layouts.load', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /usr/local/var/www/wardi/resources/views/admin/category/create.blade.php ENDPATH**/ ?>