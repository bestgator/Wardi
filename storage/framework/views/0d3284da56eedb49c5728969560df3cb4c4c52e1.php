...
<html lang="en" dir="ltr">
	...
	<head>
		...
		<?php else: ?>
			<link href="<?php echo e(asset('assets/admin/css/style.css').'?v='.filemtime(public_path('assets/admin/css/style.css'))); ?>" rel="stylesheet"/>
			...
			<div class="page-main">
							...
							<div class="right-eliment">
								<ul class="list">
									...
									<li class="bell-area">
										...
										<div class="dropdown-menu">
											<div class="dropdownmenu-wrapper" style="height: 450px; overflow-y: auto;" data-href="<?php echo e(route('order-notf-show')); ?>" id="order-notf-show">
										</div>
										</div>
									</li>
				...
				<div class="wrapper">
					...
					<nav id="sidebar" class="nav-sidebar">
						...
						<?php if(Auth::guard('admin')->user()->IsSuper()): ?>
							<p style="margin-right: auto; margin-left: auto; text-align: center"> Version: 1.0.0</p>
							<p style="margin-right: auto; margin-left: auto; text-align: center"> Developed by <a style="color: purple;" href="//best-gator.com/" title="" target="_blank">Best Gator</a></p>
						<?php endif; ?>
    ...
    <script src="<?php echo e(asset('assets/admin/js/vendors/vue.js')); ?>"></script>
		...
		<script src="<?php echo e(asset('assets/admin/js/nicEdit.js').'?v='.filemtime(public_path('assets/admin/js/nicEdit.js'))); ?>"></script>
		...
		<!-- AJAX Js-->
		<script src="<?php echo e(asset('assets/admin/js/myscript.js').'?v='.filemtime(public_path('assets/admin/js/myscript.js'))); ?>"></script>
...
<?php /**PATH /usr/local/var/www/wardi/resources/views/layouts/admin.blade.php ENDPATH**/ ?>