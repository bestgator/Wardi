                    ...
                    <div class="product-description">
                      ...
                      <form id="geniusformdata" action="<?php echo e(route('admin-cat-update',$data->id)); ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                          <div class="col-lg-4">
                            <div class="left-area">
                                <h4 class="heading"><?php echo e(__('Name En')); ?> *</h4>
                                <p class="sub-heading"><?php echo e(__('(In Any Language)')); ?></p>
                            </div>
                          </div>
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="name_en" placeholder="<?php echo e(__('Enter Name EN')); ?>" required="" value="<?php echo e($data->name_en); ?>">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          <div class="col-lg-4">
                            <div class="left-area">
                                <h4 class="heading"><?php echo e(__('Name Ar')); ?> *</h4>
                                <p class="sub-heading"><?php echo e(__('(In Any Language)')); ?></p>
                            </div>
                          </div>
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="name_ar" placeholder="<?php echo e(__('Enter Name AR')); ?>" required="" value="<?php echo e($data->name_ar); ?>">
                          </div>
                        </div>
...
<?php echo $__env->make('layouts.load', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /usr/local/var/www/wardi/resources/views/admin/category/edit.blade.php ENDPATH**/ ?>